...
### 프로젝트 일정(WBS)
![wbs](images/docs/wbs_image.png)

### API 명세서
![API 명세서](images/docs/API_specification_image.png)


## 아키텍처 & 설계 산출물

### 서비스 플로우
![서비스 플로우](images/architecture/flow_chart.png)
...
#### 추후
![시스템아미텍처 추후](images/architecture/SystemArchitecture_Ideal.png)


### 클라우드 아키텍처
![클라우드 아키텍처](images/architecture/UhokCloundArchitecture.drawio.png)
